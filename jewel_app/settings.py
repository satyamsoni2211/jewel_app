"""
Django settings for jewel_app project.
...
SECRET_KEY = '=m3+p-r(7($my_u50$2t^7r(_i0i7vu&tawe7$1^uqjhv^!m%a'
...
WSGI_APPLICATION = 'jewel_app.wsgi.application'
